...
public class AppComponents extends Components implements IAppComponents {
    ...
    @Override
    public Resource aText(Resource parent, String name, Object... properties) throws Exception {
        return createComponent(getComponentPath(parent, name), ComponentType.TEXT, properties);
    }
}
